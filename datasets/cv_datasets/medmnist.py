...
def get_default_root():
    ...
    dirpath = os.path.join(current_dir, "data")
...
class MedMNIST(Dataset):
    ...
    def __init__(self,
        ...
        if root is not None and os.path.exists(root):
            self.root = root
        elif root is not None and not os.path.exists(root):
            os.makedirs(root)
            self.root = root
        else:
...
def get_medmnist(args, alg, dataset_name, num_labels, num_classes,labeled_percentage, data_dir='./data', include_lb_to_ulb=True):
    ...
    train_labeled_data, train_labeled_targets, train_unlabeled_data, train_unlabeled_targets = split_ssl_data(args, 
                                                                                                              total_data, 
                                                                                                              total_targets, 
                                                                                                              num_classes, 
