...
class AlgorithmBase:
    ...
    def set_dataset(self):
        ...
        dataset_dict = get_dataset(self.args, self.algorithm, self.args.dataset, self.args.num_labels, self.args.num_classes,self.args.labeled_percentage, self.args.data_dir, self.args.include_lb_to_ulb)
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            if self.it >= self.num_train_iter or self.should_stop_training == True:
                break
